		...
		<div style="display: flex; justify-content: center; margin-top: 20px;">
			<form id="updateNoticeFrm">
				<table class="detail-table">
					...
					<tr>
						<th>제목</th>	
						<td colspan="3"><textarea class="input flexible" name="qnaTitle" rows="1" cols="100" required>${ notice.title }</textarea></td>
				    </tr>
			    	
			    	<tr>
				    	<th>내용</th>	
				    	<td colspan="3"><textarea class="input flexible" name="qnaContent" rows="16" cols="100" required>${ notice.content }</textarea></td>
				    </tr>
