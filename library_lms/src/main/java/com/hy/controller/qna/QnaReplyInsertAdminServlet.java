...
public class QnaReplyInsertAdminServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		// 파라미터 받기
		String qnaNoStr = request.getParameter("qnaId");
		...
		int qnaId = Integer.parseInt(qnaNoStr);
		...
		// 등록 후 상세페이지로 리다이렉트
		response.sendRedirect(request.getContextPath()+ "/qna/list/detail/admin?qnaId=" + qnaId);
	}
}
