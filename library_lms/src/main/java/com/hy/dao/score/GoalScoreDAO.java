...
public class GoalScoreDAO {
	...
	public int insertGoalScore(SqlSession session, GoalScore dto) {
	    return session.insert("com.hy.mapper.score.ScoreMapper.insertGoalScore", dto);
	}
	
    // 시험 분류 학년별 조회
    public List<ExamType> selectExamTypesByGrade(SqlSession session, int memberGrade) {
        return session.selectList("com.hy.mapper.score.ScoreMapper.selectExamTypesByGrade", memberGrade);
    }
    ...
    public List<GoalScore> selectGoalScoresByMemberAndExam(SqlSession session, int memberNo, int examTypeId) {
        return session.selectList("com.hy.mapper.score.ScoreMapper.selectGoalScoresByMemberAndExam", 
    ...
    public int deleteGoalScoresByMemberAndExam(Map<String, Integer> param) {
        ...
        return session.delete("com.hy.mapper.score.ScoreMapper.deleteGoalScoresByMemberAndExam", param);
    }
